...
* Hardware Availability: [twitter](https://twitter.com/monksoffunkJP), [Booth](https://25keys.booth.pm/items/8262069)

Make example for this keyboard (after setting up your build environment):

    qmk compile -kb 25keys/aleth42/rev2_4_ortho -km default
